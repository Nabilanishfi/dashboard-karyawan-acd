<nav class="navbar navbar-dashboard navbar-expand-lg bg-body-tertiary py-3" style="backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); background-color: rgba(255, 255, 255, 0.7);">
    <div class="container d-flex justify-content-between" style="width: 90%; margin: 0px auto">
      ...
      <div class="links d-flex gap-2 align-items-center">
        <a href="{{ route('data.karyawanorganik.karyawan.index') }}">
            Karyawan Organik
        </a>
        <a href="{{ route('data.turnoverorganik.karyawan.index') }}">
            TurnOver Organik
        </a>
        <a href="{{ route('data.turnovertpp.karyawan.index') }}" class="text-center" style="width: 180px;">
            TurnOver TPP
        </a>
        <a href="{{ route('data.dataplt.karyawan.index') }}" class="text-center" style="width: 180px;">
            Data TLP
        </a>
      </div>
