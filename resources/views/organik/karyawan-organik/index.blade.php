                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="{{ route('data.karyawanorganik.karyawan.edit', $karyawan) }}" class="text-decoration-none text-success">
                                    ...
                                    <form action="{{ route('data.karyawanorganik.karyawan.destroy', $karyawan) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button type="submit" onclick="return confirm('Yakin ingin menghapus data?')" href="{{ route('data.karyawanorganik.karyawan.destroy', $karyawan) }}" class="text-danger" style="border: none; outline: none; background-color: transparent; padding: 0; margin: 0" >
                                            <svg width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
