...
@section('title', 'Edit Data PLT')

@section('container')
    <div class="container-edit-dataplt">
        <div class="mt-3">
        ...
        <div class="mt-4" style="border-bottom: 2px solid rgb(214, 212, 212);">
            <h5 style="font-size: 14px;">Ubah Data PLT</h5>
        </div>
        <div class="mt-3 py-4 px-4 rounded" style="background-color: rgb(255, 255, 255);">
            <h4 class="mb-2">Data PLT</h4>
            <form action="{{ route('data.dataplt.karyawan.update', $karyawan) }}" method="post">
                @csrf
                @method('PUT')
                <div class="d-flex justify-content-between gap-2">
                    <div class="d-flex flex-column gap-1" style="width: 45%">
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <input type="text" name="nik" id="nik" class="px-3 py-2 @error('nik') is-invalid @enderror" placeholder="masukkan nik.." value="{{ $karyawan->nik }}">
                            @error('nik')
                        ...
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <select class="form-select form-select-md @error('jabatan_existing') is-invalid @enderror" style="color: rgb(131, 131, 131);" name="jabatan_existing" id="jabatan_existing">
                                ...
                                @if ($karyawan->existing)
                                    <option selected hidden value="{{ $karyawan->jabatan_existing }}">{{ $karyawan->namaexisting }}</option>
                                @endif
                        ...
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <select class="form-select form-select-md @error('jabatan_usulan_plt') is-invalid @enderror" style="color: rgb(131, 131, 131);" name="jabatan_usulan_plt" id="jabatan_usulan_plt">
                                ...
                                @if ($karyawan->usulan_plt)
                                    <option selected hidden value="{{ $karyawan->jabatan_usulan_plt }}">{{ $karyawan->namaplt }}</option>
                                @endif
                        ...
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <select class="form-select form-select-md @error('jabatan_usulan_plh') is-invalid @enderror" style="color: rgb(131, 131, 131);" name="jabatan_usulan_plh" id="jabatan_usulan_plh">
                                ...
                                @if ($karyawan->usulan_plh)
                                    <option selected hidden value="{{ $karyawan->jabatan_usulan_plh }}">{{ $karyawan->namaplh }}</option>
                                @endif
                    ...
                    <div class="d-flex flex-column gap-1" style="width: 45%">
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="" style="width: 48%;">
                                    <input type="date" name="awal_plt" id="awal_plt" class="px-3 py-2 @error('awal_plt') is-invalid @enderror" style="color:rgb(138, 138, 138); width: 100%" value="{{ $karyawan->awal_plt }}">
                                    @error('awal_plt')
                                        <div class="" style="font-size: 13px; color: red;">
                                            *{{ $message }}
                                        </div>
                                ...
                                <span>-</span>
                                <div class="" style="width: 48%;">
                                    <input type="date" name="akhir_plt" id="akhir_plt" class="px-3 py-2 @error('akhir_plt') is-invalid @enderror" style="color:rgb(138, 138, 138); width: 100%" value="{{ $karyawan->akhir_plt }}">
                                    @error('akhir_plt')
                                        <div class="" style="font-size: 13px; color: red;">
                                            *{{ $message }}
                                        </div>
                        ...
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="" style="width: 48%">
                                    <input type="date" name="awal_plh" id="awal_plh" class="px-3 py-2 @error('awal_plh') is-invalid @enderror" style="color:rgb(138, 138, 138); width: 100%;" value="{{ $karyawan->awal_plh }}">
                                    @error('awal_plh')
                                        <div class="" style="font-size: 13px; color: red;">
                                            *{{ $message }}
                                        </div>
                                ...
                                <span>-</span>
                                <div class="" style="width: 48%;">
                                    <input type="date" name="akhir_plh" id="akhir_plh" class="px-3 py-2 @error('akhir_plh') is-invalid @enderror" style="color:rgb(138, 138, 138); width: 100%;" value="{{ $karyawan->akhir_plh }}">
                                    @error('akhir_plh')
                                        <div class="" style="font-size: 13px; color: red;">
                                            *{{ $message }}
                                        </div>
                        ...
                        <div class="input mt-3 d-flex flex-column gap-1">
                            ...
                            <input type="text" name="nodin_spr" id="nodin_spr" class="px-3 py-2 @error('nodin_spr') is-invalid @enderror" style="color:rgb(138, 138, 138)" placeholder="masukkan no. nodin/spr.." value="{{ old('nodin_spr') }}" value="{{ $karyawan->nodin_spr }}">
                            @error('nodin_spr')
                                <div class="" style="font-size: 13px; color: red;">
                                    *{{ $message }}
                                </div>
