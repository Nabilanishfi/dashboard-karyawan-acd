                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="{{ route('data.turnovertpp.karyawan.edit', $karyawan) }}" class="text-decoration-none text-success">
                                            ...
                                            <form action="{{ route('data.turnovertpp.karyawan.destroy', $karyawan) }}" method="post">
                                                @csrf
                                                @method('delete')
